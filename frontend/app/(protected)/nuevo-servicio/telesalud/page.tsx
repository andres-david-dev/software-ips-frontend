...
export function TelesaludWizard({ defaultStep = 1 }: { defaultStep?: 1 | 2 | 3 }) {
      ...
      <section className="bg-[#f7fafc] rounded-2xl border border-zinc-200 shadow-sm p-6">
          ...
          <div className="mt-6 rounded-2xl border border-zinc-200 bg-white">
            <form
              ...
              onSubmit={(e) => {
                ...
                setCurrentStep(2);
                router.push("/nuevo-servicio/telesalud/paso-2");
              }}
            >
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        {currentStep === 2 && (
          <Paso2Form
            ...
            onBack={() => {
              setCurrentStep(1);
              router.push("/nuevo-servicio/telesalud");
            }}
            onCancel={() => {
            ...
            onSubmit={() => {
              ...
              setCurrentStep(3);
              router.push("/nuevo-servicio/telesalud/paso-3");
            }}
          />
        )}
...
export default function NuevoServicioTelesalud() {
  return <TelesaludWizard defaultStep={1} />;
}
